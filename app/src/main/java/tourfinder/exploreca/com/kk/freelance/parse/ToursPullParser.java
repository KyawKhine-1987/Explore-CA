package tourfinder.exploreca.com.kk.freelance.parse;
...
public class ToursPullParser {
	...
	private static final String LOG_TAG = ToursPullParser.class.getSimpleName();
	...
	public List<Tour> parseXML(Context context) {
		Log.i(LOG_TAG, "TEST : parseXML() called...");
	...
	private void handleText(String text) {
		Log.i(LOG_TAG, "TEST : handleText() called...");
	...
	private void handleStartTag(String name) {
		Log.i(LOG_TAG, "TEST : handleStartTag() called...");
